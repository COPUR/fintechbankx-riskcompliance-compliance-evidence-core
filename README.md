...
- **Squad:** Compliance Evidence Squad
- **Repo Kümesi:** `compliance-core`
- **Bounded Context:** `compliance`
- **Ana Capability:** Compliance evidence and audit traceability
- **Dönüşüm Wave:** 4
...
- `Compliance evidence and audit traceability` kapsamında kod, sözleşme, test, runbook ve release artefaktları.
